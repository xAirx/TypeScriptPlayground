...
/*  TypeScript’s compiler will complain here as providing a defaultValue is compulsory.
...
//////////// Exporting our ToastContext and Provider
...
export const ToastProvider: React.FC = ({ children }) => { */
	...
	// Usestate, passing in ToastConfigType, so that we can set our types correctly.
	// and typecheck what goes into our state
